...
class WaitingKeywords(LibraryComponent):
    ...
    @keyword
    def wait_for_function(self, page_function, timeout=None):
        """
        ...
        """
        return self.loop.run_until_complete(self.async_func.wait_for_function_async(page_function, timeout))
